...
export const initialQuestions = [
  ...
  },
  {
    ...
    options: null,
    correctAnswer: "13",
    explanation: "We know that (x + y)Â² = xÂ² + yÂ² + 2xy. Substituting the values: (5)Â² = xÂ² + yÂ² + 2(6) => 25 = xÂ² + yÂ² + 12 => xÂ² + yÂ² = 25 - 12 = 13.",
  ...
  },
  {
    ...
    explanation: "If you multiply any non-zero rational number (e.g., 2) by an irrational number (e.g., âˆš3), the product (2âˆš3) cannot be represented as a simple fraction, meaning it is always irrational.",
    hint: "Try multiplying a simple fraction like 1/2 with âˆš2. Is the result rational?",
    xpReward: 20,
    timeLimit: 20
  },
  ...
  // Class 10 - Trigonometry
  {
    ...
    explanation: "Using trigonometric identity sinÂ² Î¸ + cosÂ² Î¸ = 1: cosÂ² Î¸ = 1 - sinÂ² Î¸ = 1 - (3/5)Â² = 1 - 9/25 = 16/25. Thus, cos Î¸ = âˆš(16/25) = 4/5.",
  ...
  },
  {
    ...
    options: null,
    correctAnswer: "2",
    explanation: "We know sinÂ² Î¸ + cosÂ² Î¸ = 1 for any angle. Thus, sinÂ² 30Â° + cosÂ² 30Â° = 1. Also, tan 45Â° = 1. So, 1 + 1 = 2.",
    hint: "Recall trigonometric identity sinÂ² Î¸ + cosÂ² Î¸ = 1, and the value of tan 45Â°.",
    xpReward: 40,
    timeLimit: 30
  }
];
